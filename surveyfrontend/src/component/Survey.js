        ...
        <>
                ...
                <Col>
                    <Form>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>1. Email*</h5></Form.Label>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>2. Motivation*</h5></Form.Label>
                            <br/>
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                            <Form.Label className={"input-label"}><h5>3. Falls deine Motivation diese Woche drei oder
                                weniger Sterne beträgt, bitte schreibe kurz warum:</h5></Form.Label>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>4. Team*</h5></Form.Label>
                            <br/>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>5. Falls deine Antwort bei Frage 5 drei oder
                                weniger Sterne beträgt, bitte schreibe kurz warum:</h5></Form.Label>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>6.
                                Arbeiten*</h5></Form.Label>
                            <br/>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={"input-label"}><h5>7. Falls Du deine Leistung mit drei oder weniger
                                Sternen beurteilt hast, bitte schreibe kurz warum:</h5></Form.Label>
                            <Form.Control onChange={e => setQuestionSeven(e.target.value)} defaultValue={questionSeven}
                                          className={"reasonWork"} type="text"/>
                        </Form.Group>
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                            <Form.Label className={"input-label"}><h5>8. Wie war die Zusammenarbeit mit deiner/deinem
                                Ausbildner*in?*</h5></Form.Label>
                        ...
                        <br/>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                            <Form.Label className={"input-label"}><h5>9. Was Du noch sagen möchtest...
                            </h5></Form.Label>
            ...
            <ToastContainer position={"top-start"}>
                <Toast onClose={() => setShowSend(false)} bg={"success"} show={showSend} delay={3000} autohide>
                    ...
                    <Toast.Body className={'text-white'}><h4>Die Umfrage wurde abgesendet.</h4></Toast.Body>
                </Toast>
                <Toast onClose={() => setShowFailed(false)} bg={"danger"} show={showFailed} delay={3000} autohide>
                    ...
                    <Toast.Body className={'text-white'}><h4>Der/Die Praktikant*in existiert nicht oder die Eingaben
                        sind ungültig.</h4></Toast.Body>
                </Toast>
            </ToastContainer>
        </>
    );
